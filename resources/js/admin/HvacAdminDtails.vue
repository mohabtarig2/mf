...
{{accepted}}               <div class="spinner-border " :class="classes" role="status" >
  ...
  <tbody>
    <tr>
         <td>  3D </td>
        <td class="text-center"><a :href="tender.hvac_files.threeDPath" download="" class="btn btn-light">
    ...
    <tr>
      <td>المخطط المعماري</td>
        <td class="text-center"><a :href="tender.hvac_files.ArchitectPath" download="" class="btn btn-light">
             <i class="text-dark fas fa-cloud-download-alt" style="font-size:10px"></i>
            <small class="text-muted">تحميل </small>
            </a>
        </td>
     ...
     <tr v-if="tender.hvac_files.servicesPath">

      <td> الخدمات</td>
        <td class="text-center"><a :href="tender.hvac_files.servicesPath" download="" class="btn btn-light">
              <i class="text-dark fas fa-cloud-download-alt" style="font-size:10px"></i>
            <small class="text-muted">تحميل </small>
            </a>
        </td>
    ...
    <tr>
      ...
      <td> الملف الانشائي</td>
        <td class="text-center"><a :href="tender.hvac_files.StructurePath" download="" class="btn btn-light">
            <i class="text-dark fas fa-cloud-download-alt" style="font-size:10px"></i>
            <small class="text-muted">تحميل </small>
            </a>
        </td>
      ...
      <td>جدول المواصفات</td>
        <td class="text-center"><a :href="tender.hvac_files.SpecificationsPath" download="" class="btn btn-light">
           <i class="text-dark fas fa-cloud-download-alt" style="font-size:10px"></i>
            <small class="text-muted">تحميل </small>
            </a>
        </td>
     ...
     <tr>
      ...
      <td> الهوية</td>
        <td class="text-center"><a :href="tender.hvac_files.identityPath" download="" class="btn btn-light">
              <i class="text-dark fas fa-cloud-download-alt" style="font-size:10px"></i>
            <small class="text-muted">تحميل </small>
            </a>
        </td>
      ...
      <td> خارطة الارض</td>
        <td class="text-center"><a :href="tender.hvac_files.mapPath" download="" class="btn btn-light">
              <i class="text-dark fas fa-cloud-download-alt" style="font-size:10px"></i>
            <small class="text-muted">تحميل </small>
            </a>
        </td>
...
methods: {
  ...
  let data = new FormData();
      ...
      data.append("reason", this.reason);
        ...
        this.success=6
          $('.reject').modal('hide');
                $('.modal-backdrop').css('display','hide');
...
// this.classes="text-dark d-block";
 $('button').addClass('btn btn-sm btn-success').attr("disabled", 'disabled');
        axios.get('/admin/hvac/accept/'+this.$route.params.id).then(res=>{
        this.success =1;
